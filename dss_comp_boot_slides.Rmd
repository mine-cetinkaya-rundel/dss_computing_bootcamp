...
## Download Rmd template and upload to RStudio

- Go to http://bit.ly/dss_comp_boot_temp and save the Rmd file

- Then, upload to RStudio
...
```{r}
gap_upd <- read.csv("https://bit.ly/gap_data")
```
